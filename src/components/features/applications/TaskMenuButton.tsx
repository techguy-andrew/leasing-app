...
export default function TaskMenuButton({ onEdit, onDelete }: TaskMenuButtonProps) {
  ...
  return (
    <div className="relative inline-block" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-[3%] min-w-[10rem] w-max max-w-[90vw] bg-white border border-gray-200 rounded-lg shadow-xl z-50 overflow-hidden">
          <div className="py-[3%]">
            <button
              onClick={handleEdit}
